        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <NavLink
                to="/admin/dashboard"
                className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-blue-700 dark:hover:bg-meta-4 ${
                  (pathname === '/' || pathname.includes('dashboard')) &&
                  'bg-blue-700 dark:bg-meta-4'
                }`}
              >
                <svg
              ...
              <li>
                <NavLink
                  to="/tables"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-blue-700 dark:hover:bg-meta-4 ${
                    pathname.includes('tables') && 'bg-blue-700 dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/chart"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-blue-700 dark:hover:bg-meta-4 ${
                    pathname.includes('chart') && 'bg-blue-700 dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
